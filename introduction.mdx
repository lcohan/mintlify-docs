...
description: "Alphacast is a financial data analytics platform for managing datasets and connecting to global data providers via API."
---
...
- **Connect to external data providers** — including FRED, BLS, World Bank, OECD, IMF, BIS, and major Latin American central banks. Browse the live catalog at [alphacast.io/explore/apis](https://www.alphacast.io/explore/apis).
