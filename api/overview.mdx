...
<Note>
  Programmatic pipeline operations (create, edit steps, run, monitor) are available through the Alphacast MCP server. See the [MCP](/mcp/overview) tab for setup and tool reference.
</Note>
