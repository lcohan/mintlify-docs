...
description: "Alphacast includes built-in data provider connectors for FRED, BLS, World Bank, OECD, IMF, BIS, and Latin American central banks. Browse, search, and pull series through a single unified REST API."
---

Alphacast ships with built-in connectors for a curated set of data providers, covering central banks, statistical agencies, and international organizations from around the world. You can browse a provider's catalog hierarchically, search it by keyword, or fetch a specific series by ID — all through the same REST API.
...
| `inegi` | INEGI — Instituto Nacional de Estadística y Geografía (Mexico) |
| `bcra` | BCRA — Banco Central de la República Argentina |
| `bis` | BIS — Bank for International Settlements |
| `oecd` | OECD Statistics |
| `imf` | IMF — International Monetary Fund |
| `bcb-opendata` | BCB — Banco Central do Brasil |
| `banxico` | Banxico — Banco de México |
