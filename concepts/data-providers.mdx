...
description: "Alphacast includes 16 built-in data provider connectors — FRED, BLS, World Bank, OECD, and more. Browse, search, and pull series through a single unified REST API."
---

Alphacast ships with built-in connectors for 16 data providers, covering central banks, statistical agencies, and financial data sources from around the world. You can browse a provider's catalog hierarchically, search it by keyword, or fetch a specific series by ID — all through the same REST API.
